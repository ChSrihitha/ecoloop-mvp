...
export interface Analysis{category:string;riskLevel:'Low'|'Medium'|'High';batteryHandling:string;disposalRecommendation:string;safetyGuidance:string;reasoning:string}
...
export interface Pickup{id:string;itemId:string;recyclerId:string;address:string;date:string;time:string;quantity:number;contact:string;status:PickupStatus;createdAt:string}
export interface Certificate{id:string;pickupId:string;number:string;issuedAt:string}
