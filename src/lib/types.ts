...
export interface Pickup{id:string;itemId:string;recyclerId:string;address:string;date:string;time:string;quantity:number;contact:string;status:PickupStatus;createdAt:string;userId?:string}
